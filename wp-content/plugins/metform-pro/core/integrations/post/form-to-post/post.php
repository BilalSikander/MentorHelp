...
class Post
{
    ...
    {
        $data = [
            'post_type' => $form_settings['mf_post_submission_post_type'],
            'post_title' => $form_data[$form_settings['mf_post_submission_title']],
            'post_content' => $form_data[$form_settings['mf_post_submission_content']],
            'post_status' => 'publish',
     ...
     * ----------------------------
     */
    public function mf_set_thumbnail($post_id, $file_upload_info, $form_settings)
    {
        $file = '';
        foreach ($file_upload_info as $key => $value) {
            ...
            if (!$upload_file['error']) {
                ...
                if (!is_wp_error($attachment_id) && $form_settings['mf_post_submission_featured_image'] === $key ) {
