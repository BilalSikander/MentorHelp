...
final class SiteFooter extends Library_Document
{
    ...
    {
        return __('Footer', 'elemental-theme-builder');
    }
    ...
    public function get_container_attributes()
    {
        ...
        $attributes = [
            ...
            'class' => 'elementor elementor-' . $id . ' elemental-site-footer',
        ];
    ...
    public function print_elements_with_wrapper($data = null)
    {
        ...
        do_action('before_print_elemental_site_footer', $data);

        ?>
        <footer <?php echo Utils::render_html_attributes($this->get_container_attributes()); ?>>
        ...
        do_action('after_print_elemental_site_footer', $data);
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'singular_pages',
            [
                'label' => __('Select Type(s) of the Singular Pages', 'elemental-theme-builder'),
                'label_block' => true,
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => $this->getSingularTypes(),
                'condition' => [
        ...
        $this->add_control(
            'archive_pages',
            [
                'label' => __('Select Type(s) of the Archive Pages', 'elemental-theme-builder'),
                'label_block' => true,
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => $this->getArchiveTypes(),
                'condition' => [
     ...
     * @return array
     */
    private function getSingularTypes()
    {
     ...
     * @return array
     */
    private function getArchiveTypes()
    {
